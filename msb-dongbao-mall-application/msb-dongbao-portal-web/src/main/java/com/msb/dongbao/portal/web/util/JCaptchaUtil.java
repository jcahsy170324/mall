 ...
 * @Description TODO
 * @Author jincheng
 * @Date 2022/3/13 15:21
 * @Version 1.0
 **/
public class JCaptchaUtil {

    public static final ImageCaptchaService service = imageCaptchaService();
    ...
    public static ImageCaptchaService imageCaptchaService(){
        //背景
        UniColorBackgroundGenerator backgroundGenerator = new UniColorBackgroundGenerator(200,100);
        //字
